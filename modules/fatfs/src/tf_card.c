...
// #define PUERTO_ORIGINAL

// #define FCLK_SLOW()
// #define FCLK_FAST()

#ifdef PUERTO_ORIGINAL
#define FCLK_SLOW() /* Set SCLK = PCLK2 / 64 */
...
#else
/* Set SCLK = PCLK2 / 64 */
#define FCLK_SLOW() SPI_CTL0(SPI0) = (SPI_CTL0(SPI0) & ~0x38) | 0x28;
/* Set SCLK = PCLK2 / 2 */
#define FCLK_FAST() SPI_CTL0(SPI0) = (SPI_CTL0(SPI0) & ~0x38) | 0x00;

#define CS_HIGH()   gpio_bit_set(GPIOA, GPIO_PIN_8)
#define CS_LOW()    gpio_bit_reset(GPIOA, GPIO_PIN_8)
#endif
